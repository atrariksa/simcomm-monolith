    ...
    "paths": {
        ...
        "/shop-products": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "ShopProduct details",
                        "name": "shopproduct",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateTransferProduct"
                        }
                    }
                ],
                "responses": {
        ...
        "/warehouse-stored-products": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "WarehouseStoredProduct details",
                        "name": "warehousestoredproduct",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.WarehouseStoredProduct"
                        }
                    }
                ],
                "responses": {
        ...
        "/warehouse-stored-products/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "WarehouseStoredProduct ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "model.ShopProduct": {
            ...
            "properties": {
                ...
                "detail": {
                    "$ref": "#/definitions/model.ShopProductDetails"
                },
                "id": {
                    "type": "integer"
                },
        ...
        "model.ShopProductDetails": {
            "type": "object",
            "properties": {
                "shop_product_details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.ShopProductDetail"
                    }
                }
            }
        },
